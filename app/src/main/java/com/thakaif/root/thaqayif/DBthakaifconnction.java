...
/**
 * Created by ٍ SafiSoft on 9/23/17.
 */
...
public class DBthakaifconnction extends SQLiteOpenHelper {
    ...
    public Cursor queryquestions(String table, String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy) {
    ...
    public Cursor querytime(String table, String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String orderBy) {
        return myDataBase.query("time",null,null,null,null,null,null);
    }
