...
public class SportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrongsound = MediaPlayer.create(SportActivity.this, R.raw.wrongsound);
        wrongsound.setAudioStreamType(AudioManager.STREAM_MUSIC);
        bagdrob = MediaPlayer.create(SportActivity.this,R.raw.bagdrob);
        bagdrob.setAudioStreamType(AudioManager.STREAM_MUSIC);


        myDbHelper = new DBthakaifconnction(SportActivity.this);
        try {
        ...
        c = myDbHelper.querysport("sport", null, null, null, null, null, null);
        c.moveToPosition(0);
        //c.getPosition();
        //c.moveToFirst();
    ...
    public void ifbouttomanswerwrght(){
        ...
        new CountDownTimer(1000, 1000) { //count to remove heartbrahe gif
            ...
            public void onFinish() {
                ...
                myDbHelper.updateRecord("sport","score",idsumstring,numberAsString);
                myDbHelper.updateRecord("score","sport_score","1",numberAsString);


                String deletposs =c.getString(0);
                myDbHelper.deleteRecordAlternate("sport","_id",deletposs);
                ...
                if (c.moveToNext())
                {
                    ...
                    Intent celebrateactivity =new Intent( SportActivity.this, CelebrateActivity.class);
    ...
    public void elseanswerwrongbouttom(){
        ...
        if (txvlifes.getText().equals("0")){
            ...
            MobileAds.initialize(SportActivity.this, "ca-app-pub-5637187199850424/5441358861");//real add
            adViewsince =(AdView) findViewById(R.id.adViewsince);
            AdRequest adRequest = new AdRequest.Builder().build();
            adViewsince.loadAd(adRequest);
