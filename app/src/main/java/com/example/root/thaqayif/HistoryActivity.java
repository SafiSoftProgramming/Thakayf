...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrongsound = MediaPlayer.create(HistoryActivity.this, R.raw.wrongsound);
        wrongsound.setAudioStreamType(AudioManager.STREAM_MUSIC);
        bagdrob = MediaPlayer.create(HistoryActivity.this,R.raw.bagdrob);
        bagdrob.setAudioStreamType(AudioManager.STREAM_MUSIC);


        myDbHelper = new DBthakaifconnction(HistoryActivity.this);
        try {
        ...
        c = myDbHelper.queryhistory("history", null, null, null, null, null, null);
        c.moveToPosition(0);
        //c.getPosition();
        //c.moveToFirst();
    ...
    public void ifbouttomanswerwrght(){
        ...
        new CountDownTimer(1000, 1000) { //count to remove heartbrahe gif
            ...
            public void onFinish() {
                ...
                myDbHelper.updateRecord("history","score",idsumstring,numberAsString);
                myDbHelper.updateRecord("score","history_score","1",numberAsString);


                String deletposs =c.getString(0);
                myDbHelper.deleteRecordAlternate("history","_id",deletposs);
                ...
                if (c.moveToNext())
                {
                    ...
                    Intent celebrateactivity =new Intent( HistoryActivity.this, CelebrateActivity.class);
    ...
    public void elseanswerwrongbouttom(){
        ...
        if (txvlifes.getText().equals("0")){
            ...
            MobileAds.initialize(HistoryActivity.this, "ca-app-pub-5637187199850424/5441358861");//real add
            adViewsince =(AdView) findViewById(R.id.adViewsince);
            AdRequest adRequest = new AdRequest.Builder().build();
            adViewsince.loadAd(adRequest);
