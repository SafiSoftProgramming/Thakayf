...
public class SinceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mInterstitialAd.setAdUnitId("ca-app-pub-5637187199850424/7673125757");//real
        ...
        wrongsound = MediaPlayer.create(SinceActivity.this, R.raw.wrongsound);
        wrongsound.setAudioStreamType(AudioManager.STREAM_MUSIC);
        bagdrob = MediaPlayer.create(SinceActivity.this,R.raw.bagdrob);
        bagdrob.setAudioStreamType(AudioManager.STREAM_MUSIC);


         myDbHelper = new DBthakaifconnction(SinceActivity.this);
        try {
      ...
      //  Toast.makeText(SinceActivity.this, "Successfully Imported", Toast.LENGTH_SHORT).show();
        ...
        c = myDbHelper.querysince("since", null, null, null, null, null, null);
        c.moveToPosition(0);
        //c.getPosition();
        //c.moveToFirst();
    ...
    public void ifbouttomanswerwrght(){
        ...
        new CountDownTimer(1000, 1000) { //count to remove heartbrahe gif
            ...
            public void onFinish() {
                ...
                myDbHelper.updateRecord("since","score",idsumstring,numberAsString);
                myDbHelper.updateRecord("score","since_score","1",numberAsString);

                String deletposs =c.getString(0);
                myDbHelper.deleteRecordAlternate("since","_id",deletposs);
                ...
                if (c.moveToNext())
                {
                    ...
                    Intent celebrateactivity =new Intent( SinceActivity.this, CelebrateActivity.class);
    ...
    public void elseanswerwrongbouttom(){
        ...
        if (txvlifes.getText().equals("0")){
            ...
            MobileAds.initialize(SinceActivity.this, "ca-app-pub-5637187199850424/5441358861");//real add
            adViewsince =(AdView) findViewById(R.id.adViewsince);
            AdRequest adRequest = new AdRequest.Builder().build();
            adViewsince.loadAd(adRequest);
