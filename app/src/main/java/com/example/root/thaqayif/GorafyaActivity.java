...
public class GorafyaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gorafya);
        ...
        // MobileAds.initialize(this, "ca-app-pub-5637187199850424/5441358861");//real
        ...
        wrongsound = MediaPlayer.create(GorafyaActivity.this, R.raw.wrongsound);
        wrongsound.setAudioStreamType(AudioManager.STREAM_MUSIC);
        bagdrob = MediaPlayer.create(GorafyaActivity.this,R.raw.bagdrob);
        bagdrob.setAudioStreamType(AudioManager.STREAM_MUSIC);


        myDbHelper = new DBthakaifconnction(GorafyaActivity.this);
        try {
        ...
        c = myDbHelper.querygorafya("gorafya", null, null, null, null, null, null);
        c.moveToPosition(0);
        //c.getPosition();
        //c.moveToFirst();
    ...
    public void ifbouttomanswerwrght(){
        ...
        new CountDownTimer(1000, 1000) { //count to remove heartbrahe gif
            ...
            public void onFinish() {
                ...
                myDbHelper.updateRecord("gorafya","score",idsumstring,numberAsString);
                myDbHelper.updateRecord("score","gorafya_score","1",numberAsString);


                String deletposs =c.getString(0);
                myDbHelper.deleteRecordAlternate("gorafya","_id",deletposs);
                ...
                if (c.moveToNext())
                {
                    ...
                    Intent celebrateactivity =new Intent( GorafyaActivity.this, CelebrateActivity.class);
    ...
    public void elseanswerwrongbouttom(){
        ...
        if (txvlifes.getText().equals("0")){
            ...
            MobileAds.initialize(GorafyaActivity.this, "ca-app-pub-5637187199850424/5441358861");//real add
            adViewsince =(AdView) findViewById(R.id.adViewsince);
            AdRequest adRequest = new AdRequest.Builder().build();
            adViewsince.loadAd(adRequest);
